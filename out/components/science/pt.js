...
pt.commandCategory = 'science';
pt.commandDescription = 'You can look up any element on the periodic table';
pt.commandSyntax = 'pt <name/symbol/atomic number>';
pt.MISSING_ARGS_ERR_2 = Errors_1.MISSING_ARGS_ERR_METACLASS(2);
pt.groupBlockColor = {
    'alkali metal': '6462a1',
...
pt.ELEMENT_NOT_FOUND_ERR = class ELEMENT_NOT_FOUND_ERR extends ErrorSuperClass_1.default {
