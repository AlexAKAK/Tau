...
ion.commandCategory = 'science';
ion.commandDescription = 'you can look up any polyatomic ion';
ion.commandSyntax = 'ion <ion>';
ion.ions = [
...
ion.ION_NOT_FOUND_ERR = class ION_NOT_FOUND_ERR extends ErrorSuperClass_1.default {
    ...
    standardHandle(message) {
        pt_1.default.sendErrMessage(message.channel, `You must provide a valid polyatonic ion name or symbol to use the ion command, ${message.author.tag}.`);
    }
};
